    ...
    <body>
        ...
        <div class='home container-fluid'>
            <div class='welcome row'>
                <div class='welcome-p1 col-12 col-sm-6 align-self-center'>
                    <span class='row message-primary'>Your Needs, Our Priority</span>
                    <span class='row message-secondary'>Experience the best-in class service</span>
                    <div class='row justify-content-center'>
                        <a class='col-5 m-2 btn btn-warning' href='tel:+919435052955' role='button'>
